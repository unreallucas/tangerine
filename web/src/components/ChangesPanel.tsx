    ...
    <div className="flex h-[180px] w-full shrink-0 flex-col border-t border-border @min-[700px]/diff:h-full @min-[700px]/diff:w-[220px] @min-[700px]/diff:border-l @min-[700px]/diff:border-t-0">
            ...
            <div key={file.path}>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="truncate text-md font-medium text-foreground">{fileName(file.path)}</div>
      ...
      <div className="border-t border-border px-3 py-2 @min-[700px]/diff:px-4 @min-[700px]/diff:py-3">
        ...
        <Button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg bg-foreground px-4 py-2 text-md font-medium text-background transition hover:bg-foreground/90 disabled:opacity-40 @min-[700px]/diff:py-2.5"
        >
